package WordList::ID::KBBI::ByClass::Verb;
...
1;
# ABSTRACT: Indonesian verb words from Kamus Besar Bahasa Indonesia (KBBI), 3e
...
L<ArrayData::Lingua::Word::ID::KBBI::ByClass::Verb> contains the same data.
